  ...
  return (
    ...
    >
      <div className="grid min-h-0 grid-cols-1 items-center gap-2 md:min-h-[380px] md:grid-cols-2 md:gap-16">
        ...
        {/* Texto */}
        <div className="order-2 min-h-[15rem] md:order-1 md:min-h-0">
          <AnimatePresence mode="wait">
            <motion.div
              key={index}
            ...
            >
              ...
              <p
                className="!mb-1.5 min-h-[2.5rem] text-sm font-semibold uppercase tracking-wide md:!mb-8 md:min-h-0"
                style={{ color: ACCENT }}
              >
                {slide.subtitle}
              </p>
              <p className="!mb-3 line-clamp-4 min-h-[5.75rem] max-w-md text-sm leading-relaxed text-white/70 md:!mb-12 md:min-h-0 md:text-base">
                {slide.description}
              </p>
